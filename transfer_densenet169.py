...
if __name__ == '__main__':
    ...
    fc_inputs = densenet169.classifier.in_features # 1664
    ...
    optimizer = optim.Adam(densenet169.parameters())

    # Train the model for 25 epochs
    densenet169, history = train_and_validate(
        densenet169, loss_func, optimizer, epochs=100, patience=5, save_name = model_name)
